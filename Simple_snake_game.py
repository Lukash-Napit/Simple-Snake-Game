...
#this class creates body of snake using different turtles including their movements.
class Snake:
...
screen.title("The Simple Snake Game")
screen.tracer(0)
...
#setting keys for movement of snake.
screen.listen()
...
while game_is_on:
    ...
    #this if statement detects collision with food.
